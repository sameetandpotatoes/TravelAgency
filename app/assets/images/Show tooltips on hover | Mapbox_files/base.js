...
$(function() {
    ...
    $('form#newsletter').submit(function(ev) {
        ...
        function track() {
            ...
            Views.modal.show('confirm', 'Thanks! We\'ll send you ocassional email updates.');
        }
...
function personalize() {
    var mapid = App.storage('map.id'),
        exampleid = 'examples.map-zr0njcqy';
...
App.templates = {
    ...
    nav: _("<%\nvar active = {};\nvar section = window.location.pathname.replace('-','').split('/')[1];\nif (section) active[section] = 'active';\nif ((/mapbox\\.js|mapbox-ios-sdk|mbxmapkit|tilemill|carto/).test(section)) active.developers = 'active';\nif ((/foundations/).test(section)) active.help = 'active';\n%>\n<% if (!user.id) { %>\n  <div class='strong small primary hide-mobile'>\n    <a href='/design/'     class='primary-nav-button inline pad1x pad0y round <%=active.design||''%>'>Design</a>\n    <a href='/data-platform/' class='primary-nav-button inline pad1x pad0y round <%=active.dataplatform||''%>'>Data</a>\n    <a href='/developers/' class='primary-nav-button inline pad1x pad0y round <%=active.developers||''%>'>Develop</a>\n    <a href='#'   class='primary-nav-button inline pad1x pad0y round js-industries rcon plus minus <%=active.industries||''%>'>Industries</a>\n    <a href='/enterprise/'   class='primary-nav-button inline pad1x pad0y round quiet <%=active.enterprise||''%>'>Enterprise</a>\n    <a href='/plans/'      class='primary-nav-button inline pad1x pad0y round quiet <%=active.plans||''%>'>Plans</a>\n    <a href='/help/'       class='primary-nav-button inline pad1x pad0y round quiet <%=active.help||''%>'>Help</a>\n    <a href='/blog/'       class='primary-nav-button inline pad1x pad0y round quiet <%=active.blog||''%>'>Blog</a>\n    <a href='#signin'      class='primary-nav-button inline pad1x pad0y round quiet signin auth-signin'>Sign in</a>\n    <a href='#signup'      class='signup inline button stroke'>Sign up</a>\n  </div>\n\n  <div class='show-mobile contain dropdown-container pin-topright'>\n    <a href='#menu' class='dark contain z1 big inline icon menu round quiet dropdown-button js-dropdown-button pin-right'></a>\n    <div id='menu' class='js-dropdown-menu pad4y scroll-v dropdown-menu offcanvas-top fill-white clip col12 pin-top animate'>\n      <div class='prose-big prose pad1 mobile-cols space-bottom4 clearfix'>\n        <a class='pad1 block strong col6' href='/design/'>Design</a>\n        <a class='pad1 block strong col6' href='/data-platform/'>Data</a>\n        <a class='pad1 block strong col6' href='/developers/'>Develop</a>\n        <a class='pad1 block strong col6' href='/showcase/'>Showcase</a>\n        <a class='pad1 block strong col6 signin' href='#signin'>Sign in</a>\n        <a class='pad1 block strong col6 signup' href='#signup'>Sign up</a>\n      </div>\n      <div class='pad1 clearfix mobile-cols space-bottom4'>\n        <a class='pad1 block col6 strong quiet' href='/blog/'>Blog</a>\n        <a class='pad1 block col6 strong quiet' href='/enterprise/'>Enterprise</a>\n        <a class='pad1 block col6 strong quiet' href='/plans/'>Plans</a>\n        <a class='pad1 block col6 strong quiet' href='/help/'>Help</a>\n        <a class='pad1 block col6 strong quiet' href='/about/'>About</a>\n        <a class='pad1 block col6 strong quiet' href='/about/team/'>Team</a>\n        <a class='pad1 block col6 strong quiet' href='/jobs/'>Jobs</a>\n        <a class='pad1 block col6 strong quiet' href='/about/press/'>Press</a>\n        <a class='pad1 block col6 strong quiet' href='/about/press-kit/'>Press kit</a>\n        <a class='pad1 block col6 strong quiet' href='/tos/'>Legal</a>\n        <a class='pad1 block col6 strong quiet' href='/contact/'>Contact</a>\n      </div>\n       <div class='pad1 clearfix mobile-cols space-bottom4'>\n        <a class='pad1 block col6 strong quiet' href='/industries/realestate'>Real Estate</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/transportation'>Transportation</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/outdoors'>Fintness &amp; Outdoors</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/social'>Social</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/agriculture'>Agriculture</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/government'>Government</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/finance'>Finance</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/insurance'>Insurance</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/naturalresources'>Natural Resources</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/security'>Security</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/health'>Health</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/media'>Media</a>\n      </div>\n    </div>\n  </div>\n\n  <% } else { %>\n\n  <div class='primary small strong pad0y row1 hide-mobile'>\n    <a href='/projects/' class='primary-nav-button inline pad1x pad0y round icon folder <%=active.projects||''%>'>Projects</a>\n    <a href='/styles/' class='primary-nav-button inline pad1x pad0y round icon paint <%=active.styles||''%>'>Styles</a>\n    <a href='/data/'     class='primary-nav-button inline pad1x pad0y round icon cloud <%=active.data||''%>'>Data</a>\n    <a href='/account/'  class='primary-nav-button inline pad1x pad0y round <%=active.account||''%>'>\n      <img class='dot avatar' src='<%= user.avatar %>' />\n      <%= _(user.id || user.name).escape() %>\n    </a>\n    <a href='/help/'       class='primary-nav-button inline pad1x pad0y round quiet <%=active.help||''%>'>Help</a>\n    <a href='/developers/' class='primary-nav-button inline pad1x pad0y round quiet <%=active.developers||''%>'>Developers</a>\n    <a href='/blog/'       class='primary-nav-button inline pad1x pad0y round quiet <%=active.blog||''%>'>Blog</a>\n    <a href='#signout' tooltip='Signout' class='contain primary-nav-button inline pad1x pad0y round icon logout logout-button js-signout'></a>\n  </div>\n\n  <div class='show-mobile dark contain dropdown-container pin-topright'>\n    <a href='#menu' class='contain z1 big inline icon menu round quiet dropdown-button js-dropdown-button pin-right'></a>\n    <div id='menu' class='js-dropdown-menu pad4y scroll-v dropdown-menu offcanvas-top fill-white clip col12 pin-top animate'>\n      <div class='prose-big prose pad1'>\n        <a class='pad1 block strong icon folder' href='/projects/'>Projects</a>\n        <a class='pad1 block strong icon paint' href='/styles/'>Styles</a>\n        <a class='pad1 block strong icon cloud' href='/data/'>Data</a>\n        <a class='pad1 block strong' href='/account/'>\n          <img class='inline dot align-middle avatar' src='<%= user.avatar %>' />\n          <%= _(user.id || user.name).escape() %>\n        </a>\n        <a class='pad1 block strong' href='/developers/'>Developers</a>\n      </div>\n      <div class='pad1 clearfix mobile-cols space-bottom4'>\n        <a class='pad1 block col6 strong quiet' href='/blog/'>Blog</a>\n        <a class='pad1 block col6 strong quiet' href='/plans/'>Plans</a>\n        <a class='pad1 block col6 strong quiet' href='/help/'>Help</a>\n        <a class='pad1 block col6 strong quiet' href='/about/'>About</a>\n        <a class='pad1 block col6 strong quiet' href='/about/team/'>Team</a>\n        <a class='pad1 block col6 strong quiet' href='/jobs/'>Jobs</a>\n        <a class='pad1 block col6 strong quiet' href='/about/press/'>Press</a>\n        <a class='pad1 block col6 strong quiet' href='/about/press-kit/'>Press kit</a>\n        <a class='pad1 block col6 strong quiet' href='/tos/'>Legal</a>\n        <a class='pad1 block col6 strong quiet' href='/contact/'>Contact</a>\n      </div>\n      <a class='pad4 col6 block strong icon logout quiet js-signout'  href='#signout'>Logout</a>\n    </div>\n  </div>\n\n<% } %>\n").template(),
...
App.access = function(id) {
    ...
    if (App.user && App.user.accountLevel === 'staff') return true;
    return false;
};
...
App.refreshUser = function(id, callback) {
    ...
    function success(user) {
        ...
        analytics.identify(user.id, {
            ...
            email: user.email,
            plan: user.accountLevel.replace('2', '')
        });
...
App.local = function(callback) {
    if (App.sessionStorage('app.local')) try {
        return callback(null, JSON.parse(App.sessionStorage('app.local')));
    } catch(err) {
...
App.onUserLoad(function() {
    ...
    if (App.user && App.user.accountLevel === 'enterprise') {
...
Nav.prototype.events = (function() {
    ...
    events['click .js-industries']       = 'industries';
    return events;
})();
...
Nav.prototype.industries = function(ev){   
    $('.industries-subnav').toggleClass('active');
    $('.page-content').toggleClass('industries-active');
    $(ev.currentTarget).toggleClass('plus');
    return false;
};
